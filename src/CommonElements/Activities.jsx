            ...
            <div id="kt_activities" className="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
                <div className="card shadow-none rounded-0">
                                    ...
                                    <div className="timeline-content mb-10 mt-n1">
                                        ...
                                        <div className="overflow-auto pb-5">
                                            ...
                                            <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                                {/*begin::Title*/}
                                                <NavLink to="../../demo14/dist/apps/projects/project.html" className="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Meeting with customer</NavLink>
                                                {/*end::Title*/}
                                                {/*begin::Label*/}
                                                ...
                                                {/*end::Progress*/}
                                                {/*begin::Action*/}
                                                <NavLink to="../../demo14/dist/apps/projects/project.html" className="btn btn-sm btn-light btn-active-light-primary">View</NavLink>
                                                {/*end::Action*/}
                                            </div>
                                            {/*end::Record*/}
                                            {/*begin::Record*/}
                                            <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                                {/*begin::Title*/}
                                                <NavLink to="../../demo14/dist/apps/projects/project.html" className="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Project Delivery Preparation</NavLink>
                                                {/*end::Title*/}
                                                {/*begin::Label*/}
                                ...
                                <div className="timeline-item">
                                    ...
                                    <div className="timeline-content mb-10 mt-n1">
                                        ...
                                        <div className="mb-5 pe-3">
                                            {/*begin::Title*/}
                                            <NavLink to="#" className="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">3 New Incoming Project Files:</NavLink>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="d-flex align-items-center mt-1 fs-6">
                                                {/*begin::Info*/}
                                            ...
                                            <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                                ...
                                                <div className="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                    ...
                                                    <div className="ms-1 fw-bold">
                                                        {/*begin::Desc*/}
                                                        <NavLink to="../../demo14/dist/apps/projects/project.html" className="fs-6 text-hover-primary fw-bolder">Finance KPI App Guidelines</NavLink>
                                                        {/*end::Desc*/}
                                                        {/*begin::Number*/}
                                                ...
                                                <div className="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                    {/*begin::Icon*/}
                                                    <img alt="../../demo14/dist/apps/projects/project.html" className="w-30px me-3" src="/assets/media/svg/files/doc.svg" />
                                                    {/*end::Icon*/}
                                                    {/*begin::Info*/}
                                                    <div className="ms-1 fw-bold">
                                                        {/*begin::Desc*/}
                                                        <NavLink to="#" className="fs-6 text-hover-primary fw-bolder">Client UAT Testing Results</NavLink>
                                                        {/*end::Desc*/}
                                                        {/*begin::Number*/}
                                                ...
                                                <div className="d-flex flex-aligns-center">
                                                    {/*begin::Icon*/}
                                                    <img alt="../../demo14/dist/apps/projects/project.html" className="w-30px me-3" src="/assets/media/svg/files/css.svg" />
                                                    {/*end::Icon*/}
                                                    {/*begin::Info*/}
                                                    <div className="ms-1 fw-bold">
                                                        {/*begin::Desc*/}
                                                        <NavLink to="#" className="fs-6 text-hover-primary fw-bolder">Finance Reports</NavLink>
                                                        {/*end::Desc*/}
                                                        {/*begin::Number*/}
                                    ...
                                    <div className="timeline-content mb-10 mt-n1">
                                        ...
                                        <div className="pe-3 mb-5">
                                            ...
                                            <div className="fs-5 fw-bold mb-2">Task
                                                <NavLink to="#" className="text-primary fw-bolder me-1">#45890</NavLink>merged with
                                                <NavLink to="#" className="text-primary fw-bolder me-1">#45890</NavLink>in “Ads Pro Admin Dashboard project:</div>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="d-flex align-items-center mt-1 fs-6">
                                                {/*begin::Info*/}
                                            ...
                                            <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                                ...
                                                <div className="overlay me-10">
                                                    ...
                                                    <div className="overlay-wrapper">
                                                        <img alt="img" className="rounded w-150px" src="/assets/media/stock/300x270/9.jpg" />
                                                    </div>
                                                    {/*end::Image*/}
                                                    {/*begin::Link*/}
                                                    <div className="overlay-layer bg-dark bg-opacity-10 rounded">
                                                        <NavLink to="#" className="btn btn-sm btn-primary btn-shadow">Explore</NavLink>
                                                    </div>
                                                    {/*end::Link*/}
                                                </div>
                                                {/*end::Item*/}
                                                ...
                                                <div className="overlay me-10">
                                                    {/*begin::Image*/}
                                                    <div className="overlay-wrapper">
                                                        <img alt="img" className="rounded w-150px" src="/assets/media/stock/300x270/11.jpg" />
                                                    </div>
                                                    {/*end::Image*/}
                                                    {/*begin::Link*/}
                                                    <div className="overlay-layer bg-dark bg-opacity-10 rounded">
                                                ...
                                                <div className="overlay">
                                                    {/*begin::Image*/}
                                                    <div className="overlay-wrapper">
                                                        <img alt="img" className="rounded w-150px" src="/assets/media/stock/300x270/6.jpg" />
                                                    </div>
                                                    {/*end::Image*/}
                                                    {/*begin::Link*/}
                                                    <div className="overlay-layer bg-dark bg-opacity-10 rounded">
                                    ...
                                    <div className="timeline-content mb-10 mt-n1">
                                        ...
                                        <div className="pe-3 mb-5">
                                            ...
                                            <div className="fs-5 fw-bold mb-2">New case
                                                <NavLink to="#" className="text-primary fw-bolder me-1">#67890</NavLink>is assigned to you in Multi-platform Database Design project</div>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="overflow-auto pb-5">
                                                {/*begin::Wrapper*/}
                                                <div className="d-flex align-items-center mt-1 fs-6">
                                                    ...
                                                    {/*end::Info*/}
                                                    {/*begin::User*/}
                                                    <NavLink to="#" className="text-primary fw-bolder me-1">Alice Tan</NavLink>
                                                    {/*end::User*/}
                                                </div>
                                                {/*end::Wrapper*/}
                                            </div>
                                        ...
                                        <div className="overflow-auto pb-5">
                                            ...
                                            <div className="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
                                                ...
                                                <div className="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                                    ...
                                                    {/*end::Content*/}
                                                    {/*begin::Action*/}
                                                    <NavLink to="#" className="btn btn-primary px-6 align-self-center text-nowrap" data-bs-toggle="modal" data-bs-target="#kt_modal_">Proceed</NavLink>
                                                    {/*end::Action*/}
                                                </div>
                                                {/*end::Wrapper*/}
                                            </div>
                                    ...
                                    <div className="timeline-content mt-n1">
                                        ...
                                        <div className="pe-3 mb-5">
                                            ...
                                            <div className="fs-5 fw-bold mb-2">New order
                                                <NavLink to="#" className="text-primary fw-bolder me-1">#67890</NavLink>is placed for Workshow Planning &amp; Budget Estimation</div>
                                            {/*end::Title*/}
                                            {/*begin::Description*/}
                                            <div className="d-flex align-items-center mt-1 fs-6">
                                                {/*begin::Info*/}
                                                ...
                                                {/*end::Info*/}
                                                {/*begin::User*/}
                                                <NavLink to="#" className="text-primary fw-bolder me-1">Jimmy Bold</NavLink>
                                                {/*end::User*/}
                                            </div>
                                            {/*end::Description*/}
                                        </div>
                    ...
                    <div className="card-footer py-5 text-center" id="kt_activities_footer">
                        <NavLink to="../../demo14/dist/pages/profile/activity.html" className="btn btn-bg-body text-primary">View All Activities
