                    ...
                    <div className="card-header pe-5" id="kt_drawer_chat_messenger_header">
                        ...
                        <div className="card-title">
                            ...
                            <div className="d-flex justify-content-center flex-column me-3">
                                <NavLink to="#" className="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1">Brian Cox</NavLink>
                                {/*begin::Info*/}
                        ...
                        <div className="card-toolbar">
                            ...
                            <div className="me-2">
                                ...
                                <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                    ...
                                    {/*begin::Menu item*/}
                                    <div className="menu-item px-3">
                                        <NavLink to="#" className="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">Add Contact</NavLink>
                                    </div>
                                    {/*end::Menu item*/}
                                    {/*begin::Menu item*/}
                                    <div className="menu-item px-3">
                                        <NavLink to="#" className="menu-link flex-stack px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Invite Contacts
                                            <i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a contact email to send an invitation" /></NavLink>
                                    </div>
                                    {/*end::Menu item*/}
                                    {/*begin::Menu item*/}
                                    <div className="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                                        ...
                                        <div className="menu-sub menu-sub-dropdown w-175px py-4">
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="#" className="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Create Group</NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="#" className="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Invite Members</NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="#" className="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">Settings</NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                        </div>
                                        {/*end::Menu sub*/}
                            ...
                            <div className="d-flex justify-content-start mb-10">
                                ...
                                <div className="d-flex flex-column align-items-start">
                                    ...
                                    <div className="d-flex align-items-center mb-2">
                                        ...
                                        {/*begin::Details*/}
                                        <div className="ms-3">
                                            <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary me-1">Brian Cox</NavLink>
                                ...
                                <div className="d-flex flex-column align-items-end">
                                    ...
                                    <div className="d-flex align-items-center mb-2">
                                        ...
                                        <div className="me-3">
                                            ...
                                            <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary ms-1">You</NavLink>
                                        </div>
                                        {/*end::Details*/}
                                        {/*begin::Avatar*/}
                                        <div className="symbol symbol-35px symbol-circle">
                            ...
                            <div className="d-flex justify-content-start mb-10">
                                ...
                                <div className="d-flex flex-column align-items-start">
                                    ...
                                    <div className="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start" data-kt-element="message-text">You can unwatch this repository immediately by clicking here:
                                        <NavLink to="https://keenthemes.com">Keenthemes.com</NavLink></div>
                                    {/*end::Text*/}
                                </div>
                                {/*end::Wrapper*/}
                            </div>
