                                ...
                                <div className="py-5">
                                    ...
                                    <div data-kt-search-element="suggestions">
                                        ...
                                        <div className="mh-375px scroll-y me-n7 pe-7">
                                            {/*begin::User*/}
                                            <NavLink to="#" className="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                                {/*begin::Avatar*/}
                                        ...
                                        <div className="mh-375px scroll-y me-n7 pe-7">
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={0}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Emma Smith</NavLink>
                                                ...
                                                <div className="ms-2 w-100px">
                                                    <select className="form-select form-select-solid form-select-sm" data-control="select2" value={2} data-hide-search="true">
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={1}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Melody Macy</NavLink>
                                                ...
                                                {/*begin::Access menu*/}
                                                <div className="ms-2 w-100px">
                                                    <select className="form-select form-select-solid form-select-sm" data-control="select2" value={1} data-hide-search="true">
                                                        <option value={1}>Guest</option>
                                                        <option value={2}>Owner</option>
                                                        <option value={3}>Can Edit</option>
                                                    </select>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={2}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Max Smith</NavLink>
                                                ...
                                                {/*begin::Access menu*/}
                                                <div className="ms-2 w-100px">
                                                    <select className="form-select form-select-solid form-select-sm" data-control="select2" value={3} data-hide-search="true">
                                                        <option value={1}>Guest</option>
                                                        <option value={2}>Owner</option>
                                                        <option value={3}>Can Edit</option>
                                                    </select>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={3}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Sean Bean</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={4}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Brian Cox</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={5}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Mikaela Collins</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={6}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Francis Mitcham</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={7}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Olivia Wild</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={8}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Neil Owen</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={9}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Dan Wilson</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={10}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Emma Bold</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={11}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Ana Crown</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={12}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Robert Doe</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={13}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">John Miller</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={14}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Lucy Kunic</NavLink>
                                            ...
                                            <div className="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id={15}>
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    {/*begin::Details*/}
                                                    <div className="ms-5">
                                                        <NavLink to="#" className="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Ethan Wilder</NavLink>
