                ...
                <div className="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body scroll-y pt-10 pb-15 px-lg-17">
                            {/*begin::Options*/}
                            <div id="opt21s" data-kt-element="options">
                                {/*begin::Notice*/}
                                ...
                                <div className="pb-10">
                                    ...
                                    >
                                        ...
                                        {/*end::Svg Icon*/}
                                        <span className="d-block fw-bold text-start">
                                            <span className="text-dark fw-bolder d-block fs-3">SMS</span>
                                            <span className="text-muted fw-bold fs-6">
                            ...
                            {/*end::Options*/}
                            {/*begin::Apps*/}
                            <div className="d-none" id="apps">
                                {/*begin::Heading*/}
                                <h3 className="text-dark fw-bolder mb-7">Authenticator Apps</h3>
                                {/*end::Heading*/}
                                {/*begin::Description*/}
                                <div className="text-gray-500 fw-bold fs-6 mb-10">
                                    ...
                                    <div className="pt-5 text-center">
                                        <img src={qrCode} alt={qrCode} className="mw-150px" />
                                    </div>
                                    {/*end::QR code image*/}
                                </div>
                                {/*end::Description*/}
                                ...
                                {/*end::Notice*/}
                                {/*begin::Form*/}
                                <form onSubmit={submit} data-kt-element="apps-form" className="form" action="#">
                                    {/*begin::Input group*/}
