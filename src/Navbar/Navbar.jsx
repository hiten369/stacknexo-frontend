...
const Navbar = () => {
    ...
    useEffect(() => {
        if (localStorage.getItem('923hufweh8934rbuf3489h348ryc34ry890xcr348efq3we90y')) {
            let data = JSON.parse(localStorage.getItem('stackNUser'));
    ...
    return (
        <>
            {/*begin::Header*/}
            <div id="kt_header" style={{ paddingTop: '7px' }} className="header">
                {/*begin::Container*/}
                <div className="container-fluid d-flex flex-stack">
                    ...
                    <div className="d-flex align-items-center me-5">
                        ...
                        <div className="ms-5 ms-md-10">
                            {/*begin::Toggle*/}
                            <button type="button" className="btn btn-flex btn-active-color-white align-items-cenrer justify-content-center justify-content-md-between align-items-lg-cenrer flex-md-content-between bg-white bg-opacity-10 btn-color-gray-500 px-0 ps-md-6 pe-md-5 h-30px w-30px h-md-35px w-md-200px" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start">
                            ...
                            {/*end::Toggle*/}
                            {/*begin::Menu*/}
                            <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg fw-bold w-200px pb-3" data-kt-menu="true">
                                {/*begin::Menu item*/}
                                <div className="menu-item px-3">
                                    <div className="menu-content fs-7 text-dark fw-bolder px-3 py-4">Select department:</div>
                                </div>
                                {/*end::Menu item*/}
                                ...
                                {/*begin::Menu item*/}
                                <div className="menu-item px-3">
                                    <NavLink to="#" className="menu-link px-3">Accounting &amp; Finance</NavLink>
                                </div>
                                {/*end::Menu item*/}
                                {/*begin::Menu item*/}
                                <div className="menu-item px-3">
                                    <NavLink to="#" className="menu-link px-3">Human Resources</NavLink>
                                </div>
                                {/*end::Menu item*/}
                                {/*begin::Menu item*/}
                                <div className="menu-item px-3">
                                    <NavLink to="#" className="menu-link px-3">Marketing</NavLink>
                                </div>
                                {/*end::Menu item*/}
                                {/*begin::Menu item*/}
                                <div className="menu-item px-3">
                                    <NavLink to="#" className="menu-link px-3">Warehouse</NavLink>
                                </div>
                                {/*end::Menu item*/}
                                {/*begin::Menu item*/}
                                <div className="menu-item px-3">
                                    <NavLink to="#" className="menu-link px-3">Production</NavLink>
                                </div>
                                {/*end::Menu item*/}
                            </div>
                            {/*end::Menu*/}
                            ...
                            <div className="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                                ...
                                <div className="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    ...
                                    <div className="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
                                        <span className="text-muted fs-8 fw-bold lh-1 mb-1">{firstName}</span>
                                    ...
                                    <div className="symbol symbol-30px symbol-md-40px">
                                        ...
                                        <Avatar size="37" style={{ 'fontWeight': 'bold' }} color={'black'} name={`${firstName} ${lastName}`} />
                                    </div>
                                    {/*end::Symbol*/}
                                </div>
                                {/*end::User info*/}
                                ...
                                <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                    ...
                                    <div className="menu-item px-3">
                                        <div className="menu-content d-flex align-items-center px-3">
                                            ...
                                            {/*begin::Username*/}
                                            <div className="d-flex flex-column">
                                                <div className="fw-bolder d-flex align-items-center fs-5">{`${firstName} ${lastName}`}
                                                    <span className="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pro</span></div>
                                                <p className="fw-bold text-muted text-hover-primary fs-7">{userEmail}</p>
                                            </div>
                                            {/*end::Username*/}
                                        </div>
                                    </div>
                                    ...
                                    <div className="menu-item px-5">
                                        <NavLink to="../../demo14/dist/account/overview.html" className="menu-link px-5">My Profile</NavLink>
                                    </div>
                                    {/*end::Menu item*/}
                                    {/*begin::Menu item*/}
                                    <div className="menu-item px-5">
                                        <NavLink to="../../demo14/dist/apps/projects/list.html" className="menu-link px-5">
                                    ...
                                    <div className="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                                        ...
                                        <div className="menu-sub menu-sub-dropdown w-175px py-4">
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="../../demo14/dist/account/referrals.html" className="menu-link px-5">Referrals</NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="../../demo14/dist/account/billing.html" className="menu-link px-5">Billing</NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="../../demo14/dist/account/statements.html" className="menu-link px-5">Payments</NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="../../demo14/dist/account/statements.html" className="menu-link d-flex flex-stack px-5">Statements
                                                    <i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="View your statements" /></NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                            {/*begin::Menu separator*/}
                                            <div className="separator my-2" />
                                    ...
                                    {/*begin::Menu item*/}
                                    <div className="menu-item px-5">
                                        <NavLink to="../../demo14/dist/account/statements.html" className="menu-link px-5">My Statements</NavLink>
                                    </div>
                                    {/*end::Menu item*/}
                                    {/*begin::Menu separator*/}
                                    <div className="separator my-2" />
                                    ...
                                    <div className="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                                        ...
                                        <div className="menu-sub menu-sub-dropdown w-175px py-4">
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="../../demo14/dist/account/settings.html" className="menu-link d-flex px-5 active">
                                                    <span className="symbol symbol-20px me-4">
                                                        <img className="rounded-1" src="/assets/media/flags/united-states.svg" alt="" />
                                                    </span>English</NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                                <NavLink to="../../demo14/dist/account/settings.html" className="menu-link d-flex px-5">
                                                    <span className="symbol symbol-20px me-4">
                                                        <img className="rounded-1" src="/assets/media/flags/spain.svg" alt="" />
                                                    </span>Spanish</NavLink>
                                            </div>
                                            {/*end::Menu item*/}
                                            {/*begin::Menu item*/}
                                            <div className="menu-item px-3">
                                    ...
                                    <div className="menu-item px-5 my-1">
                                        <NavLink to="../../demo14/dist/account/settings.html" className="menu-link px-5">Account Settings</NavLink>
                                    </div>
                                    {/*end::Menu item*/}
                                    {/*begin::Menu item*/}
                                    <div className="menu-item px-5">
                                        <NavLink to="../../demo14/dist/authentication/flows/basic/sign-in.html" className="menu-link px-5">Sign Out</NavLink>
                                    </div>
                                    {/*end::Menu item*/}
                                    {/*begin::Menu separator*/}
                                    <div className="separator my-2" />
                                    ...
                                    <div className="menu-item px-5">
                                        <div className="menu-content px-5">
                                            <label className="form-check form-switch form-check-custom form-check-solid pulse pulse-success" htmlFor="kt_user_menu_dark_mode_toggle">
                                                <input className="form-check-input w-30px h-20px" type="checkbox" defaultValue={1} name="mode" id="kt_user_menu_dark_mode_toggle" data-kt-url="../../demo14/dist/index.html" />
