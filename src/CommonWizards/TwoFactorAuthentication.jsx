...
import TwoFactorAuthenticationModal from '../CommonElements/TwoFactorAuthenticationModal'
...
const TwoFactorAuthentication = (props) => {
    ...
    const remove = async () => {
        ...
        if (ans.success) {
            ...
            props.setAAlert('danger', ans.message);
        }
    };
    ...
    return (
        <div>
                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c7952755f"
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="card-px text-center pt-15 pb-15">
                                                ...
                                                {/*begin::Action*/}
                                                <button
                                                    disabled={data.forced2FA}
                                                    className="btn btn-primary er fs-6 px-8 py-4"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_two_factor_authentication"
                                                >
                                                    {data.forced2FA ? 'Already Enabled' : 'Enable Two-factor Authentication'}

                                                </button>
                                                <button onClick={remove} className="btn ms-3 btn-outline-danger">Remove 2FA</button>
                                                {/*end::Action*/}
                                            </div>
                                            {/*end::Heading*/}
                                            {/*begin::Illustration*/}
            ...
            <TwoFactorAuthenticationModal setAlert={props.setAlert} />
        </div>
    )
}
