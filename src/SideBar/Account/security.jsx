                            ...
                            <div className="d-flex flex-column flex-column-fluid container-fluid">
                                ...
                                <div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
                                    ...
                                    <div className="page-title d-flex flex-column me-3">
                                        {/*begin::Title*/}
                                        <h1 className="d-flex text-dark fw-bolder my-1 fs-3">Security</h1>
                                        {/*end::Title*/}
                                        {/*begin::Breadcrumb*/}
                                        <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                                            ...
                                            {/*end::Item*/}
                                            {/*begin::Item*/}
                                            <li className="breadcrumb-item text-gray-500">Security</li>
                                            {/*end::Item*/}
                                        </ul>
                                        {/*end::Breadcrumb*/}
                                    </div>
                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c78bd9051"
                                            ...
                                            <div className="card card-xxl-stretch mb-5 mb-xl-10">
                                                ...
                                                <div className="card-header card-header-stretch">
                                                    ...
                                                    <div className="card-toolbar">
                                                        <ul
                                                            className="nav nav-tabs nav-line-tabs nav-stretch border-transparent fs-5 fw-bolder"
                                                        ...
                                                        >
                                                            <li className="nav-item">
                                                                <NavLink
                                                                    ...
                                                                    data-bs-toggle="tab"
                                                                    to="#kt_security_summary_tab_pane_hours"
                                                                >
                                                                    12 Hours
                                                                </NavLink>
                                                            </li>
                                                            <li className="nav-item">
                                                                <NavLink
                                                                    ...
                                                                    to="#kt_security_summary_tab_pane_day"
                                                                >
                                                                    Day
                                                                </NavLink>
                                                            </li>
                                                            <li className="nav-item">
                                                                <NavLink
                                                                    ...
                                                                    to="#kt_security_summary_tab_pane_week"
                                                                >
                                                                    Week
                                                                </NavLink>
                                                            </li>
                                                    ...
                                                    <div className="tab-content">
                                                            ...
                                                            <div className="row p-0 mb-5 px-9">
                                                                ...
                                                                <div className="col">
                                                                    <div className="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                                                                        <span className="fs-4 fw-bold text-success d-block">
                                                                            User Sign-in
                                                                        </span>
                                                                        <span
                                                                            className="fs-2hx fw-bolder text-gray-900"
                                                                            data-kt-countup="true"
                                                                ...
                                                                <div className="col">
                                                                    <div className="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                                                                        <span className="fs-4 fw-bold text-primary d-block">
                                                                            Admin Sign-in
                                                                        </span>
                                                                        <span
                                                                            className="fs-2hx fw-bolder text-gray-900"
                                                                ...
                                                                <div className="col">
                                                                    <div className="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                                                                        <span className="fs-4 fw-bold text-danger d-block">
                                                                            Failed Attempts
                                                                        </span>
                                                                        <span
                                                                            className="fs-2hx fw-bolder text-gray-900"
                                                                    ...
                                                                    <ul className="nav nav-pills nav-line-pills border rounded p-1">
                                                                        <li className="nav-item me-2">
                                                                            <NavLink
                                                                                ...
                                                                                to="#kt_security_summary_tab_pane_hours_agents"
                                                                            >
                                                                                Agents
                                                                            </NavLink>
                                                                        </li>
                                                                        <li className="nav-item">
                                                                            <NavLink
                                                                                ...
                                                                                to="#kt_security_summary_tab_pane_hours_clients"
                                                                            >
                                                                                Clients
                                                                            </NavLink>
                                                                        </li>
                                                            ...
                                                            <div className="row p-0 mb-5 px-9">
                                                                ...
                                                                <div className="col">
                                                                    <div className="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                                                                        ...
                                                                        <span
                                                                            className="fs-2hx fw-bolder text-gray-800"
                                                                            data-kt-countup="true"
                                                                    ...
                                                                    <ul className="nav nav-pills nav-line-pills border rounded p-1">
                                                                        <li className="nav-item me-2">
                                                                            <NavLink
                                                                                ...
                                                                                to="#kt_security_summary_tab_pane_day_agents"
                                                                            >
                                                                                Agents
                                                                            </NavLink>
                                                                        </li>
                                                                        <li className="nav-item">
                                                                            <NavLink
                                                                                ...
                                                                                to="#kt_security_summary_tab_pane_day_clients"
                                                                            >
                                                                                Clients
                                                                            </NavLink>
                                                                        </li>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="row p-0 mb-5 px-9">
                                                                ...
                                                                <div className="col">
                                                                    <div className="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                                                                        <span className="fs-lg-4 fs-6 fw-bold text-success d-block">
                                                                            User Sign-in
                                                                        </span>
                                                                        <span
                                                                            className="fs-lg-2hx fs-2 fw-bolder text-gray-800"
                                                                            data-kt-countup="true"
                                                                ...
                                                                <div className="col">
                                                                    <div className="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                                                                        <span className="fs-lg-4 fs-6 fw-bold text-primary d-block">
                                                                            Admin Sign-in
                                                                        </span>
                                                                        <span
                                                                            className="fs-lg-2hx fs-2 fw-bolder text-gray-800"
                                                                ...
                                                                <div className="col">
                                                                    <div className="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                                                                        <span className="fs-lg-4 fs-6 fw-bold text-danger d-block">
                                                                            Failed Attempts
                                                                        </span>
                                                                        <span
                                                                            className="fs-lg-2hx fs-2 fw-bolder text-gray-800"
                                                                    ...
                                                                    <ul className="nav nav-pills nav-line-pills border rounded p-1">
                                                                        <li className="nav-item me-2">
                                                                            <NavLink
                                                                                ...
                                                                                to="#kt_security_summary_tab_pane_week_agents"
                                                                            >
                                                                                Agents
                                                                            </NavLink>
                                                                        </li>
                                                                        <li className="nav-item">
                                                                            <NavLink
                                                                                ...
                                                                                to="#kt_security_summary_tab_pane_week_clients"
                                                                            >
                                                                                Clients
                                                                            </NavLink>
                                                                        </li>
                                                ...
                                                <div className="card-body pt-5">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="d-flex flex-stack align-items-center flex-wrap">
                                                            <h4 className="text-gray-400 fw-bold mb-0 pe-2">
                                                                Recent Alerts
                                                            </h4>
                                                                ...
                                                                <div className="carousel-wrapper">
                                                                    ...
                                                                    <div className="d-flex flex-column flex-grow-1">
                                                                        ...
                                                                        <p className="text-gray-600 fs-6 fw-bold pt-3 mb-0">
                                                                            In the last year, you’ve probably had to adapt
                                                            ...
                                                            <div className="carousel-item">
                                                                ...
                                                                <div className="carousel-wrapper">
                                                                    ...
                                                                    <div className="d-flex flex-column flex-grow-1">
                                                                        <NavLink
                                                                            to="#"
                                                                            className="fw-bolder text-dark text-hover-primary"
                                                                        >
                                                                            Login Attempt Failed
                                                                        </NavLink>
                                                                        <p className="text-gray-600 fs-6 fw-bold pt-3 mb-0">
                                                                            As we approach one year of working remotely, we
                                                                            wanted to take a look back and share some ways
                                                                            teams around the world have collaborated
                                                                            effectively.
                                                                        </p>
                                                                    </div>
                                                                    {/*end::Description*/}
                                                                ...
                                                                <div className="carousel-wrapper">
                                                                    ...
                                                                    <div className="d-flex flex-column flex-grow-1">
                                                                        ...
                                                                        <p className="text-gray-600 fs-6 fw-bold pt-3 mb-0">
                                                                            ...
                                                                            certification opportunity which is designed to
                                                        ...
                                                        <div className="carousel-inner pt-6">
                                                            ...
                                                            <div className="carousel-item active">
                                                                ...
                                                                <div className="carousel-wrapper">
                                                                    ...
                                                                    {/*begin::Summary*/}
                                                                    <div className="d-flex flex-stack pt-8">
                                                                        <span className="text-muted fw-bold fs-6 pe-2">
                                                ...
                                                >
                                                    ...
                                                    <tbody className="fw-6 fw-bold text-gray-600">
                                                        <tr>
                                                            ...
                                                            <td className="ps-0">
                                                                <NavLink href className="text-hover-primary text-gray-600">
                                                                    DSI: Workstation 2
                                                                </NavLink>
                                                            </td>
                                                            <td>236.125.56.78</td>
                                                            ...
                                                            <td className="ps-5">
                                                                <button
                                                                    type="button"
                                                                    data-action="copy"
                                                                    className="btn btn-active-color-primary btn-icon btn-sm btn-outline-light d-"
                                                                >
