                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c7896cd42"
                                                                ...
                                                                <div className="mb-10">
                                                                    ...
                                                                    <div>
                                                                        <select
                                                                            ...
                                                                            data-kt-select2="true"
                                                                            data-placeholder="Select option"
                                                                            data-dropdown-parent="#kt_menu_61b9c7896e346"
                                                                            data-allow-clear="true"
                                                                        >
                                                                            <option />
                                                                            <option value={1}>Approved</option>
                                                                ...
                                                                <div className="mb-10">
                                                                    ...
                                                                    <div>
                                                                        <select
                                                                            ...
                                                                            data-kt-select2="true"
                                                                            data-placeholder="Select option"
                                                                            data-dropdown-parent="#kt_menu_61b9c7896e691"
                                                                            data-allow-clear="true"
                                                                        >
                                                                            <option />
                                                                            <option value={1}>Approved</option>
                                                                ...
                                                                <div className="mb-10">
                                                                    ...
                                                                    <div>
                                                                        <select
                                                                            ...
                                                                            data-kt-select2="true"
                                                                            data-placeholder="Select option"
                                                                            data-dropdown-parent="#kt_menu_61b9c7896ee9e"
                                                                            data-allow-clear="true"
                                                                        >
                                                                            <option />
                                                                            <option value={1}>Approved</option>
