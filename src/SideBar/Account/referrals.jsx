                                ...
                                <div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
                                    ...
                                    <div className="page-title d-flex flex-column me-3">
                                        ...
                                        <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                                            ...
                                            {/*end::Item*/}
                                            {/*begin::Item*/}
                                            <li className="breadcrumb-item text-gray-500">Referrals</li>
                                            {/*end::Item*/}
                                        </ul>
                                        {/*end::Breadcrumb*/}
                                    </div>
                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c78f42768"
                                        ...
                                        <div className="card-body py-10">
                                            ...
                                            <div className="row mb-10">
                                                ...
                                                <div className="col-xl-6 mb-15 mb-xl-0 pe-5">
                                                    ...
                                                    <p className="fs-6 fw-bold text-gray-600 py-4 m-0">
                                                    ...
                                                    <NavLink
                                                        to="#"
                                                        className="btn btn-light btn-active-light-primary fw-bolder"
                                                    >
                                                        Get Started
                                                    </NavLink>
                                                </div>
                                                ...
                                                <div className="col-xl-6">
                                                    ...
                                                    <div className="d-flex">
                                                        <input
                                                            ...
                                                            name="search"
                                                            defaultValue="https://keenthemes.com/reffer/?refid=345re66787k8"
                                                        />
                                                        <button
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col">
                                                    <div className="card card-dashed flex-center min-w-175px my-3 p-6">
                                                        <span className="fs-4 fw-bold text-info pb-1 px-2">
                                                            Net Earnings
                                                        </span>
                                                ...
                                                <div className="col">
                                                    <div className="card card-dashed flex-center min-w-175px my-3 p-6">
                                                        <span className="fs-4 fw-bold text-success pb-1 px-2">
                                                            Balance
                                                        </span>
                                                        <span className="fs-lg-2tx fw-bolder d-flex justify-content-center">
                                                            $
                                                ...
                                                <div className="col">
                                                    <div className="card card-dashed flex-center min-w-175px my-3 p-6">
                                                        <span className="fs-4 fw-bold text-danger pb-1 px-2">
                                                            Avg Deal Size
                                                        </span>
                                                        <span className="fs-lg-2tx fw-bolder d-flex justify-content-center">
                                                            $
                                                ...
                                                <div className="col">
                                                    <div className="card card-dashed flex-center min-w-175px my-3 p-6">
                                                        <span className="fs-4 fw-bold text-primary pb-1 px-2">
                                                            Referral Signups
                                                        </span>
                                                        <span className="fs-lg-2tx fw-bolder d-flex justify-content-center">
                                                            $
                                            ...
                                            {/*end::Stats*/}
                                            {/*begin::Info*/}
                                            <p className="fs-5 fw-bold text-gray-600 py-6">
                                                Writing headlines for blog posts is as much an art as it is a
                                                science, and probably warrants its own post, but for now, all
                                                I’d advise is experimenting with what works for your audience,
                                                ...
                                                <div className="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                                    ...
                                                    <div className="mb-3 mb-md-0 fw-bold">
                                                        ...
                                                        <div className="fs-6 text-gray-700 pe-7">
                                                            Withdraw money securily to your bank account. Commision
                                                            is $25 per transaction under $50,000
                                                        </div>
                                                    </div>
                                                    {/*end::Content*/}
                                                    {/*begin::Action*/}
                                        ...
                                        <div id="kt_referred_users_tab_content" className="tab-content">
                                            ...
                                            >
                                                <div className="table-responsive">
                                                    {/*begin::Table*/}
                                                    <table className="table table-row-bordered table-flush align-middle gy-6">
                                                        {/*begin::Thead*/}
                                                        <thead className="border-bottom border-gray-200 fs-6 fw-bolder bg-lighten">
                                                            <tr>
