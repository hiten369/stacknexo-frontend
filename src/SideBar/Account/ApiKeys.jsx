                            ...
                            <div className="d-flex flex-column flex-column-fluid container-fluid">
                                ...
                                <div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
                                    ...
                                    <div className="page-title d-flex flex-column me-3">
                                        {/*begin::Title*/}
                                        <h1 className="d-flex text-dark fw-bolder my-1 fs-3">API Keys</h1>
                                        {/*end::Title*/}
                                        {/*begin::Breadcrumb*/}
                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c79015e10"
                                                ...
                                                <div className="d-flex flex-stack flex-grow-1">
                                                    ...
                                                    <div className="fw-bold">
                                                        <div className="fs-6 text-gray-700">
                                                            ...
                                                            provide a 4 digit amazing and create outstanding
                                                            products to serve your clients
                                        ...
                                        <div className="card-body p-0">
                                            ...
                                            <div className="table-responsive">
                                                ...
                                                >
                                                    ...
                                                    <thead className="border-gray-200 fs-5 fw-bold bg-lighten">
                                                        <tr>
                                                            <th className="w-250px min-w-175px ps-9">Label</th>
                                                            <th className="w-275px min-w-250px px-0">API Keys</th>
                                                            <th className="w-125px min-w-125px" />
                                                    ...
                                                    <tbody className="fs-6 fw-bold text-gray-600">
                                                        <tr>
                                                            <td className="ps-9">none set</td>
                                                            <td data-bs-target="license" className="ps-0">
                                                        ...
                                                        <tr>
                                                            <td className="ps-9">Docs API Key</td>
                                                            <td data-bs-target="license" className="ps-0">
                                                                fftt456765gjkkjhi83093985
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td className="ps-9">Identity Key</td>
                                                            <td data-bs-target="license" className="ps-0">
                                                        ...
                                                        <tr>
                                                            <td className="ps-9">Remore Interface</td>
                                                            <td data-bs-target="license" className="ps-0">
