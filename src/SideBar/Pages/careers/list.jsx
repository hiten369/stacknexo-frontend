                                ...
                                <div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
                                    ...
                                    <div className="page-title d-flex flex-column me-3">
                                        ...
                                        <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                                            ...
                                            {/*end::Item*/}
                                            {/*begin::Item*/}
                                            <li className="breadcrumb-item text-gray-500">Careers List</li>
                                            {/*end::Item*/}
                                        </ul>
                                        {/*end::Breadcrumb*/}
                                    </div>
                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c7855f273"
                                        ...
                                        <div className="card-body p-lg-17">
                                            ...
                                            <div className="position-relative mb-17">
                                                ...
                                                <div className="position-absolute text-white mb-8 ms-10 bottom-0">
                                                    {/*begin::Title*/}
                                                    <h3 className="text-white fs-2qx fw-bolder mb-3 m">
                                                    ...
                                                    <div className="col-md-4">
                                                        ...
                                                        <div className="card-xl-stretch me-md-6">
                                                            ...
                                                            <NavLink
                                                                ...
                                                                to="/assets/media/stock/600x400/img-73.jpg"
                                                            >
                                                                {/*begin::Image*/}
                                                                <div
                                                    ...
                                                    <div className="col-md-4">
                                                        ...
                                                        <div className="card-xl-stretch mx-md-3">
                                                            ...
                                                            <NavLink
                                                                className="d-block overlay mb-4"
                                                                data-fslightbox="lightbox-hot-sales"
                                                                to="/assets/media/stock/600x400/img-74.jpg"
                                                            >
                                                                {/*begin::Image*/}
                                                                <div
                                                                    className="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                                    ...
                                                    <div className="col-md-4">
                                                        ...
                                                        <div className="card-xl-stretch ms-md-6">
                                                            ...
                                                            <NavLink
                                                                className="d-block overlay mb-4"
                                                                data-fslightbox="lightbox-hot-sales"
                                                                to="/assets/media/stock/600x400/img-47.jpg"
                                                            >
                                                                {/*begin::Image*/}
                                                                <div
                                                                    className="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
