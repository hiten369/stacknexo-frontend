...
import CreateCampaignModal from '../../CommonElements/CreateCampaignModal'
                                ...
                                <div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
                                    ...
                                    <div className="page-title d-flex flex-column me-3">
                                        ...
                                        <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                                            ...
                                            {/*end::Item*/}
                                            {/*begin::Item*/}
                                            <li className="breadcrumb-item text-gray-500">Campaigns</li>
                                            {/*end::Item*/}
                                        </ul>
                                        {/*end::Breadcrumb*/}
                                    </div>
                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c76c915e9"
                                        ...
                                        <div className="d-flex align-items-center my-2">
                                            ...
                                            <div className="w-100px me-5">
                                                ...
                                                <select
                                                    ...
                                                    className="form-select form-select-sm bg-body border-body"
                                                >
                                    ...
                                    <div className="row g-6 g-xl-9">
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-header flex-nowrap border-0 pt-9">
                                                    ...
                                                    <div className="card-title m-0">
                                                        ...
                                                        <div className="symbol symbol-45px w-45px bg-light me-5">
                                                            <img
                                                                src="/assets/media/svg/brand-logos/twitch.svg"
                                                                alt="image"
                                                                className="p-3"
                                                            />
                                                        </div>
                                                ...
                                                <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
                                                    ...
                                                    <div className="d-flex align-items-center fw-bold">
                                                        ...
                                                        <i
                                                            className="fas fa-exclamation-circle fs-7 ms-2"
                                                            data-bs-toggle="tooltip"
                                                            title="Recurring"
                                                        />
                                                    </div>
                                        ...
                                        <div className="col-sm-6 col-xl-4">
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
                                                    {/*begin::Heading*/}
                                                    <div className="fs-2tx fw-bolder mb-3">807k</div>
                                                    {/*end::Heading*/}
                                                    {/*begin::Stats*/}
                                                    <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                                                        {/*SVG file not found: icons/duotune/arrows/arr007.svg.svg*/}
                                                        {/*begin::Number*/}
                                                        <div className="fw-bolder text-success me-2">+17.62%</div>
                                                        {/*end::Number*/}
                                                        {/*begin::Label*/}
                                                        <div className="fw-bold text-gray-400">
                                                            Followers growth
                                                    ...
                                                    <div className="d-flex align-items-center fw-bold">
                                                        ...
                                                        <span className="text-gray-400 fs-7">New trials</span>
                                                    </div>
                                                    {/*end::Indicator*/}
                                                </div>
                                                {/*end::Card body*/}
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-header flex-nowrap border-0 pt-9">
                                                    ...
                                                    <div className="card-title m-0">
                                                        ...
                                                        <div className="symbol symbol-45px w-45px bg-light me-5">
                                                            <img
                                                                src="/assets/media/svg/brand-logos/spotify.svg"
                                                                alt="image"
                                                                className="p-3"
                                                            />
                                                        </div>
                                                ...
                                                <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
                                                    {/*begin::Heading*/}
                                                    <div className="fs-2tx fw-bolder mb-3">1,073</div>
                                                    {/*end::Heading*/}
                                                    {/*begin::Stats*/}
                                                    <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                                                        {/*SVG file not found: icons/duotune/arrows/arr005.svg.svg*/}
                                                        {/*begin::Number*/}
                                                        <div className="fw-bolder text-danger me-2">+10.45%</div>
                                                        {/*end::Number*/}
                                                        {/*begin::Label*/}
                                                        <div className="fw-bold text-gray-400">
                                                    ...
                                                    <div className="d-flex align-items-center fw-bold">
                                                        ...
                                                        <span className="text-gray-400 fs-7">Impressions</span>
                                                        <i
                                                            className="fas fa-exclamation-circle fs-7 ms-2"
                                                            data-bs-toggle="tooltip"
                                        ...
                                        <div className="col-sm-6 col-xl-4">
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
                                                    {/*begin::Heading*/}
                                                    <div className="fs-2tx fw-bolder mb-3">97</div>
                                                    {/*end::Heading*/}
                                                    {/*begin::Stats*/}
                                                    <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                                                        {/*SVG file not found: icons/duotune/arrows/arr007.svg.svg*/}
                                                        {/*begin::Number*/}
                                                        <div className="fw-bolder text-success me-2">+26.1%</div>
                                                        {/*end::Number*/}
                                                        {/*begin::Label*/}
                                                        <div className="fw-bold text-gray-400">More posts</div>
                                                        {/*end::Label*/}
                                                    </div>
                                                    {/*end::Stats*/}
                                                    {/*begin::Indicator*/}
                                                    <div className="d-flex align-items-center fw-bold">
                                                        ...
                                                        <span className="text-gray-400 fs-7">Spend</span>
                                                    </div>
                                                    {/*end::Indicator*/}
                                                </div>
                                                {/*end::Card body*/}
                                        ...
                                        <div className="col-sm-6 col-xl-4">
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
                                                    {/*begin::Heading*/}
                                                    <div className="fs-2tx fw-bolder mb-3">4,109</div>
                                                    {/*end::Heading*/}
                                                    {/*begin::Stats*/}
                                                    <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                                                        {/*SVG file not found: icons/duotune/arrows/arr005.svg.svg*/}
                                                        {/*begin::Number*/}
                                                        <div className="fw-bolder text-danger me-2">+32.8%</div>
                                                        {/*end::Number*/}
                                                        {/*begin::Label*/}
                                                        <div className="fw-bold text-gray-400">
                                                            Less contributions
                                                    ...
                                                    <div className="d-flex align-items-center fw-bold">
                                                        ...
                                                        <span className="text-gray-400 fs-7">Dispute</span>
                                                        <i
                                                            className="fas fa-exclamation-circle fs-7 ms-2"
                                                            data-bs-toggle="tooltip"
                                                            title="This is the total number of new non-trial"
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-header flex-nowrap border-0 pt-9">
                                                    ...
                                                    <div className="card-title m-0">
                                                        ...
                                                        <div className="symbol symbol-45px w-45px bg-light me-5">
                                                            <img
                                                                src="/assets/media/svg/brand-logos/youtube-play.svg"
                                                                alt="image"
                                                                className="p-3"
                                                            />
                                                        </div>
                                                ...
                                                <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
                                                    {/*begin::Heading*/}
                                                    <div className="fs-2tx fw-bolder mb-3">354</div>
                                                    {/*end::Heading*/}
                                                    {/*begin::Stats*/}
                                                    <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                                                        {/*SVG file not found: icons/duotune/arrows/arr007.svg.svg*/}
                                                        {/*begin::Number*/}
                                                        <div className="fw-bolder text-success me-2">+29.45%</div>
                                                        {/*end::Number*/}
                                                        {/*begin::Label*/}
                                                        <div className="fw-bold text-gray-400">
                                                            Subscribers growth
                                                    ...
                                                    <div className="d-flex align-items-center fw-bold">
                                                        ...
                                                        <span className="text-gray-400 fs-7">Subscribers</span>
                                                    </div>
                                                    {/*end::Indicator*/}
                                                </div>
                                                {/*end::Card body*/}
                                        ...
                                        <div className="col-sm-6 col-xl-4">
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
                                                    {/*begin::Heading*/}
                                                    <div className="fs-2tx fw-bolder mb-3">566</div>
                                                    {/*end::Heading*/}
                                                    {/*begin::Stats*/}
                                                    <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                                                        {/*SVG file not found: icons/duotune/arrows/arr007.svg.svg*/}
                                                        {/*begin::Number*/}
                                                        <div className="fw-bolder text-success me-2">+11.4%</div>
                                                        {/*end::Number*/}
                                                        {/*begin::Label*/}
                                                        <div className="fw-bold text-gray-400">more clicks</div>
                                                        {/*end::Label*/}
                                                    </div>
                                                    {/*end::Stats*/}
                                                    {/*begin::Indicator*/}
                                                    <div className="d-flex align-items-center fw-bold">
                                                        ...
                                                        <span className="text-gray-400 fs-7">Profit</span>
                                                    </div>
                                                    {/*end::Indicator*/}
                                                </div>
                                                {/*end::Card body*/}
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-header flex-nowrap border-0 pt-9">
                                                    ...
                                                    <div className="card-title m-0">
                                                        ...
                                                        <div className="symbol symbol-45px w-45px bg-light me-5">
                                                            <img
                                                                src="/assets/media/svg/brand-logos/reddit.svg"
                                                                alt="image"
                                                                className="p-3"
                                                            />
                                                        </div>
                                                ...
                                                <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
                                                    {/*begin::Heading*/}
                                                    <div className="fs-2tx fw-bolder mb-3">2.1M</div>
                                                    {/*end::Heading*/}
                                                    {/*begin::Stats*/}
                                                    <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                                                        {/*SVG file not found: icons/duotune/arrows/arr007.svg.svg*/}
                                                        {/*begin::Number*/}
                                                        <div className="fw-bolder text-success me-2">-46.7%</div>
                                                        {/*end::Number*/}
                                                        {/*begin::Label*/}
                                                        <div className="fw-bold text-gray-400">more adds</div>
                                                        {/*end::Label*/}
                                                    </div>
                                                    {/*end::Stats*/}
                                                    {/*begin::Indicator*/}
                                                    <div className="d-flex align-items-center fw-bold">
                                                        ...
                                                        <span className="text-gray-400 fs-7">Retention</span>
                                                        <i
                                                            className="fas fa-exclamation-circle fs-7 ms-2"
                                                            data-bs-toggle="tooltip"
