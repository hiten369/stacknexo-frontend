                                ...
                                <div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
                                    ...
                                    <div className="page-title d-flex flex-column me-3">
                                        ...
                                        <ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                                            ...
                                            {/*end::Item*/}
                                            {/*begin::Item*/}
                                            <li className="breadcrumb-item text-gray-500">Documents</li>
                                            {/*end::Item*/}
                                        </ul>
                                        {/*end::Breadcrumb*/}
                                    </div>
                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c76dd1c8e"
                                        ...
                                        <div className="col-md-6 col-lg-4 col-xl-3">
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex justify-content-center text-center flex-column p-8">
                                                    ...
                                                    {/*end::Name*/}
                                                    {/*begin::Description*/}
                                                    <div className="fs-7 fw-bold text-gray-400">7 files</div>
                                                    {/*end::Description*/}
                                                </div>
                                                {/*end::Card body*/}
                                            </div>
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex justify-content-center text-center flex-column p-8">
                                                    ...
                                                    >
                                                        ...
                                                        {/*end::Image*/}
                                                        {/*begin::Title*/}
                                                        <div className="fs-5 fw-bolder mb-2">Customers</div>
                                                        {/*end::Title*/}
                                                    </NavLink>
                                                    {/*end::Name*/}
                                                    {/*begin::Description*/}
                                                    <div className="fs-7 fw-bold text-gray-400">3 files</div>
                                                    {/*end::Description*/}
                                                </div>
                                                {/*end::Card body*/}
                                            </div>
                                        ...
                                        <div className="col-md-6 col-lg-4 col-xl-3">
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex justify-content-center text-center flex-column p-8">
                                                    ...
                                                    {/*end::Name*/}
                                                    {/*begin::Description*/}
                                                    <div className="fs-7 fw-bold text-gray-400">25 files</div>
                                                    {/*end::Description*/}
                                                </div>
                                                {/*end::Card body*/}
                                            </div>
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex justify-content-center text-center flex-column p-8">
                                                    ...
                                                    >
                                                        ...
                                                        {/*end::Image*/}
                                                        {/*begin::Title*/}
                                                        <div className="fs-5 fw-bolder mb-2">Project Reqs..</div>
                                                        {/*end::Title*/}
                                                    </NavLink>
                                                    {/*end::Name*/}
                                                    {/*begin::Description*/}
                                                    <div className="fs-7 fw-bold text-gray-400">3 days ago</div>
                                                    {/*end::Description*/}
                                                </div>
                                                {/*end::Card body*/}
                                            </div>
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex justify-content-center text-center flex-column p-8">
                                                    ...
                                                    >
                                                        ...
                                                        {/*end::Image*/}
                                                        {/*begin::Title*/}
                                                        <div className="fs-5 fw-bolder mb-2">CRM App Docs..</div>
                                                        {/*end::Title*/}
                                                    </NavLink>
                                                    {/*end::Name*/}
                                                    {/*begin::Description*/}
                                        ...
                                        <div className="col-md-6 col-lg-4 col-xl-3">
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex justify-content-center text-center flex-column p-8">
                                                    ...
                                                    {/*end::Name*/}
                                                    {/*begin::Description*/}
                                                    <div className="fs-7 fw-bold text-gray-400">4 days ago</div>
                                                    {/*end::Description*/}
                                                </div>
                                                {/*end::Card body*/}
                                            </div>
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex justify-content-center text-center flex-column p-8">
                                                    ...
                                                    >
                                                        ...
                                                        {/*end::Image*/}
                                                        {/*begin::Title*/}
                                                        <div className="fs-5 fw-bolder mb-2">Metronic Logo</div>
                                                        {/*end::Title*/}
                                                    </NavLink>
                                                    {/*end::Name*/}
                                                    {/*begin::Description*/}
                                                    <div className="fs-7 fw-bold text-gray-400">5 days ago</div>
                                                    {/*end::Description*/}
                                                </div>
                                                {/*end::Card body*/}
                                            </div>
                                            ...
                                            <div className="card h-100">
                                                ...
                                                <div className="card-body d-flex justify-content-center text-center flex-column p-8">
                                                    ...
                                                    >
                                                        ...
                                                        {/*end::Image*/}
                                                        {/*begin::Title*/}
                                                        <div className="fs-5 fw-bolder mb-2">Orders backup</div>
                                                        {/*end::Title*/}
                                                    </NavLink>
                                                    {/*end::Name*/}
                                                    {/*begin::Description*/}
                                                    <div className="fs-7 fw-bold text-gray-400">1 week ago</div>
                                                    {/*end::Description*/}
                                                </div>
                                                {/*end::Card body*/}
                                            </div>
