...
import NewCardModal from '../../../CommonElements/NewCardModal'
							...
							<div className="d-flex flex-column flex-column-fluid container-fluid">
								...
								<div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
									...
									<div className="page-title d-flex flex-column me-3">
										{/*begin::Title*/}
										<h1 className="d-flex text-dark fw-bolder my-1 fs-3">New Card</h1>
										{/*end::Title*/}
										{/*begin::Breadcrumb*/}
										<ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
											...
											{/*end::Item*/}
											{/*begin::Item*/}
											<li className="breadcrumb-item text-gray-600">Modals</li>
											{/*end::Item*/}
											{/*begin::Item*/}
											<li className="breadcrumb-item text-gray-600">Forms</li>
											{/*end::Item*/}
											{/*begin::Item*/}
											<li className="breadcrumb-item text-gray-500">New Card</li>
											{/*end::Item*/}
										</ul>
										{/*end::Breadcrumb*/}
									</div>
													...
													<div className="mb-10">
														...
														<div>
															<select
																...
																data-dropdown-parent="#kt_menu_61b9c79d8c768"
