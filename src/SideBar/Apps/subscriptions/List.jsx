                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c7d761efe"
                                                        ...
                                                        >
                                                            ...
                                                            <div className="mb-10">
                                                                ...
                                                                <select
                                                                    ...
                                                                    data-placeholder="Select option"
                                                                    data-allow-clear="true"
                                                                    data-kt-subscription-table-filter="billing"
                                                                    data-hide-search="true"
                                                                >
                                                                    <option />
                                            ...
                                            >
                                                ...
                                                <tbody className="text-gray-600 fw-bold">
                                                    <tr>
                                                        ...
                                                        {/*begin::Billing=*/}
                                                        <td>
                                                            <div className="badge badge-light">Auto-debit</div>
                                                        </td>
                                                        {/*end::Billing=*/}
                                                        {/*begin::Product=*/}
                                                        <td>Basic</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        {/*begin::Billing=*/}
                                                        <td>
                                                            <div className="badge badge-light">Manual - Cash</div>
                                                        </td>
                                                        {/*end::Billing=*/}
                                                        {/*begin::Product=*/}
                                                        <td>Teams Bundle</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        {/*begin::Billing=*/}
                                                        <td>
                                                            <div className="badge badge-light">Manual - Paypal</div>
                                                        </td>
                                                        {/*end::Billing=*/}
                                                        {/*begin::Product=*/}
                                                        <td>Enterprise</td>
