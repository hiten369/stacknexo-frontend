                            ...
                            <div className="d-flex flex-column flex-column-fluid container-fluid">
                                ...
                                <div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
                                    ...
                                    <div className="page-title d-flex flex-column me-3">
                                        {/*begin::Title*/}
                                        <h1 className="d-flex text-dark fw-bolder my-1 fs-3">Reply</h1>
                                        {/*end::Title*/}
                                        {/*begin::Breadcrumb*/}
                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c7c523029"
                                                        ...
                                                        >
                                                            ...
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="pe-5">
                                                                    ...
                                                                    {/*begin::Preview message*/}
                                                                    <div
                                                                        className="text-muted fw-bold mw-450px"
                                                                        data-kt-inbox-message="preview"
                                                                    >
                                                        ...
                                                        <div className="d-block">
                                                            ...
                                                            <div className="d-flex align-items-center border-bottom px-8 min-h-50px">
                                                                ...
                                                                <input
                                                                    ...
                                                                    name="compose_to"
                                                                    defaultValue="e.smith@kpmg.com.au, max@kt.com, sean@dellito.com"
                                                            ...
                                                            <div
                                                                ...
                                                                className="border-0 h-250px px-3"
                                                            />
                                                            {/*end::Message*/}
                                                            {/*begin::Attachments*/}
                                                            <div
