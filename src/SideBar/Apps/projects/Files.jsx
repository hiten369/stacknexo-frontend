                                                    ...
                                                    <div className="mb-10">
                                                        ...
                                                        <div>
                                                            <select
                                                                ...
                                                                data-dropdown-parent="#kt_menu_61b9c7b3b7fda"
                                ...
                                <div className="content flex-column-fluid" id="kt_content">
                                    ...
                                    <div className="d-flex flex-wrap flex-stack my-5">
                                        ...
                                        <h3 className="fw-bolder my-2">
                                            Project Files
                                            <span className="fs-6 text-gray-400 fw-bold ms-1">+590</span>
                                        </h3>
                                        {/*end::Heading*/}
                                        {/*begin::Controls*/}
                                        <div className="d-flex my-2">
                                            ...
                                            <div className="d-flex align-items-center position-relative me-4">
                                                ...
                                                <input
                                                    type="text"
                                                    id="kt_filter_search"
                                                    className="form-control form-control-sm form-control-solid bg-body fw-bold fs-7 w-150px ps-11"
                                                    placeholder="Search"
                                                />
                                            </div>
                                            {/*end::Search*/}
