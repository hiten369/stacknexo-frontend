					...
					<div className="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
						...
						<div className="d-flex flex-column-fluid">
							...
							<div className="d-flex flex-column flex-column-fluid container-fluid">
								...
								<div className="toolbar mb-5 mb-lg-7" id="kt_toolbar">
									...
									<div className="page-title d-flex flex-column me-3">
										...
										<ul className="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
											...
											{/*end::Item*/}
											{/*begin::Item*/}
											<li className="breadcrumb-item text-gray-600">Authentication</li>
											{/*end::Item*/}
											{/*begin::Item*/}
											<li className="breadcrumb-item text-gray-600">Menu</li>
											{/*end::Item*/}
											{/*begin::Item*/}
											<li className="breadcrumb-item text-gray-500">Add New User</li>
											{/*end::Item*/}
										</ul>
										{/*end::Breadcrumb*/}
									</div>
													...
													<div className="mb-10">
														...
														<div>
															<select
																...
																data-dropdown-parent="#kt_menu_61b9c79cacc7d"
								...
								{/*end::Toolbar*/}
								{/*begin::Post*/}
								<div style={{ minHeight: '72vh' }} className="content flex-column-fluid" id="kt_content">
									{/*begin::Card*/}
									<div className="card">
										{/*begin::Card body*/}
